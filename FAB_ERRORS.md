# @fab33/fab-errors :: Документация к пакету, современная обработка ошибок (FAB_ERRORS.md)
...
Доступные базовые спеки: `INVALID_ARGUMENT_SPEC`, `OPERATION_FAILED_SPEC`, `NOT_IMPLEMENTED_SPEC`,
